...
export class DetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.activeRouter.paramMap.subscribe((route: any) => {
      ...
      this.sub3 = this.weather.getWeatherState(this.city).subscribe((humidity) => this.hum = humidity);
      this.sub4 = this.weather.getWeatherState(this.city).subscribe((windspeed) => this.wind = windspeed);
      this.sub5 = this.weather.getWeatherState(this.city).subscribe((data: any) => {
          console.log(data);
